      ...
      <section id="contacto" className="py-20 bg-secondary-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/5491131449673?text=Hola!%20Me%20comunico%20desde%20la%20web%20de%20Enermax."
              target="_blank"
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-600 text-secondary-900 font-semibold px-8 py-4 rounded-lg transition-all"
            >
